    ...
    <section className={styles.hero}>
      ...
      >
        ...
        <motion.p
          ...
          variants={itemVariants}
        >
          Construyendo aplicaciones web escalables y de alto rendimiento con React 19 y Next.js 16. Confianza para entregar soluciones de nivel empresarial que impulsan métricas de negocio.
        </motion.p>
        <motion.div
